...
add("anim", [46 4F 52 4D ?? ?? ?? ?? 41 4E 49 4D])
add("faxx", [46 4F 52 4D ?? ?? ?? ?? 46 41 58 58])
add("ftxt", [46 4F 52 4D ?? ?? ?? ?? 46 54 58 54])
add("smus", [46 4F 52 4D ?? ?? ?? ?? 53 4D 55 53])
add("cmus", [46 4F 52 4D ?? ?? ?? ?? 43 4D 55 53])
add("yuvn", [46 4F 52 4D ?? ?? ?? ?? 59 55 56 4E])
add("iff", [46 4F 52 4D ?? ?? ?? ?? 46 41 4E 54])
add("aiff", [46 4F 52 4D ?? ?? ?? ?? 41 49 46 46])
add("idx", [49 4E 44 58])
add("lz", [0x4C,0x5A,0x49,0x50]);
add("exe", [0x4D,0x5A]);
add("zip", [0x50,0x4B,0x03,0x04]); // TODO MISSGIN ALIAS
add("zip", [0x50,0x4B,0x05,0x06]); // Empty ZIP
add("zip", [0x50,0x4B,0x07,0x08]); // ZIP Spanned
...
add("asf", [0x30,0x26,0xB2,0x75,0x8E,0x66,0xCF,0x11,0xA6,0xD9,0x00,0xAA,0x00,0x62,0xCE,0x6C])
add("wma", [0x30,0x26,0xB2,0x75,0x8E,0x66,0xCF,0x11,0xA6,0xD9,0x00,0xAA,0x00,0x62,0xCE,0x6C])

add("wmv", [0x30,0x26,0xB2,0x75,0x8E,0x66,0xCF,0x11,0xA6,0xD9,0x00,0xAA,0x00,0x62,0xCE,0x6C])
...
add("cwk", [0x05,0x07,0x00,0x00,0x42,0x4F,0x42,0x4F,0x05,0x07,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01]);
add("cwk", [0x06,0x07,0xE1,0x00,0x42,0x4F,0x42,0x4F,0x06,0x07,0xE1,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01]);
...
add("tar", [0x75,0x73,0x74,0x61,0x72,0x00,0x30,0x30], 0x101)
